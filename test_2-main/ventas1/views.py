...
def quienesomos(request):
    return render(request,'ventas1/content/quienesomos.html')

def calzado(request):
    return render(request,'ventas1/content/calzado.html')

def contactanos(request):
    return render(request,'ventas1/content/contactanos.html')

def habitaciones(request):
    return render(request,'ventas1/content/habitaciones.html')
